...
<body>
                ...
                <div class="modal-window">
                    <div class="auth-container">
                        ...
                        <div class="auth text-center">
                            <!-- форма регистрации -->
                            <form action="request/register.php" class="register" method="POST">
                                <p>Регистрация</p>
                                <input class="regemail" type="text" placeholder=" e-mail" name="email" required/>
                            ...
                            <form action="request/login.php" class="login" method="POST">
                                <p>Авторизация</p>
                                <input class="logemail" type="text" placeholder=" e-mail" name="email" required/>
    ...
    <script src="js/double.button.js"></script>
