        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-md-10 col-sm-12 d-flex justify-content-start">
                    <div class="welcome">
                        <img class="catalog-image" src="3.png" alt="empty">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-md-10 col-sm-12 d-flex justify-content-center flex-column">
                    <div class="free-content flex-column justify-content-center d-flex">
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex justify-content-end">
                                <a href="demo-code.html" class="free-btn text-center">Demo and code</a>
                            </div>
                        </div>
                    </div>

                    <div class="paid-content flex-column justify-content-center d-flex">
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex justify-content-end">
                                <a href="pay.html" class="paid-btn text-center">Купить</a>
                            </div>
                        </div>
                    </div>
                </div>
